 ...
 */
class LoaderFilesystem implements Twig_LoaderInterface, Twig_ExistsLoaderInterface, Twig_SourceContextLoaderInterface
{
    ...
    protected function findTemplate($name, $throw = true)
    {
        ...
        foreach ($this->paths[$namespace] as $path) {
            ...
            $templatevariants = [];
            $templatevariants[] = $shortname . DS . $shortname . '.twig';
            $templatevariants[] = $shortname;

            foreach ($templatevariants as $templatevariant) {
                if (is_file($path.'/'.$templatevariant)) {
                    if (false !== $realpath = realpath($path.'/'.$templatevariant)) {
                        return $this->cache[$name] = $realpath;
                    }
    
                    return $this->cache[$name] = $path.'/'.$templatevariant;
                }
            }
        }
